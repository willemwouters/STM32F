...
/*======================================================================
brief:  Read the I2C flag.
param:  I2Cx --- where x can be 1 or 2 to select the I2C peripheral.
======================================================================*/
unsigned long I2C_Read_Flag_Status(I2C_TypeDef* I2Cx)
{
  u32 flag1 = 0, flag2 = 0;

  assert_param(IS_I2C_ALL_PERIPH(I2Cx));  // Check the parameters

  flag1 = I2Cx->SR1;
  flag2 = I2Cx->SR2;
  flag2 = flag2 << 16;

  flag2 = (flag1 | flag2) & FLAG_MASK;

  return  flag2;            // Return the I2C_FLAG status
}
